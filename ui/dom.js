...
function getGameDomRefs(root = document) {
  ...
  return Object.freeze({
    ...
    entryGuideButton: queryRequired("#entryGuideButton", root),
    ...
    entryGuideOverlay: queryRequired("#entryGuideOverlay", root),
    entryGuideCloseButton: queryRequired("#entryGuideCloseButton", root),
    entryGuideKicker: queryRequired("#entryGuideKicker", root),
    entryGuideTitle: queryRequired("#entryGuideTitle", root),
    entryGuideLead: queryRequired("#entryGuideLead", root),
    entryGuideBoard: queryRequired("#entryGuideBoard", root),
    entryGuideNote: queryRequired("#entryGuideNote", root),
    entryGuideProgress: queryRequired("#entryGuideProgress", root),
    entryGuideSkipButton: queryRequired("#entryGuideSkipButton", root),
    entryGuidePrevButton: queryRequired("#entryGuidePrevButton", root),
    entryGuideNextButton: queryRequired("#entryGuideNextButton", root),
